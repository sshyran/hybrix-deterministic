...
//deterministic = require('./modules/deterministic/dash/deterministic.js');
...
var mode = 'dash';  // other modes: bitcoinjslib.bitcoin, ethereum, lisk
...
var tx = {
  'dash': {
    ...
    'target_address':'XoVHRkb33J4DBCDNK8dEuNkrQHUoBiF1CU',  // where to transact to
    'contract':'DASH',                                       // TODO? -> smart contract address
    'amount':"15000",                                          // amount to send
      ...
      unspents : [
        {
          ...
          "outputIndex" : 0,
          "address" : "XoVHRkb33J4DBCDNK8dEuNkrQHUoBiF1CU",
