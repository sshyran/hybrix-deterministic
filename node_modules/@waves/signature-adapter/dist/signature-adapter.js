...
},{"./prepareTx":14,"@waves/signature-generator":undefined}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var signature_generator_1 = require("@waves/signature-generator");
...
var Adapter = /** @class */ (function () {
    ...
    Adapter.prototype.makeSignable = function (forSign) {
        return new Signable_1.Signable(forSign, this);
    };
    Adapter.prototype.isAvailable = function () {
        return Promise.resolve();
    };
    Adapter.prototype.onDestroy = function (cb) {
        return;
    };
    Adapter.initOptions = function (options) {
        this._code = options.networkCode;
        signature_generator_1.config.set({ networkByte: options.networkCode });
    };
    Adapter.getUserList = function () {
        return Promise.resolve([]);
    };
    Adapter.isAvailable = function () {
...
},{"../Signable":1,"@waves/signature-generator":undefined}],3:[function(require,module,exports){
"use strict";
...
},{"./Adapter":2,"@waves/ledger":undefined}],4:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./Adapter":2,"@waves/signature-generator":undefined}],5:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./Adapter":2}],6:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var prepareTx_1 = require("../prepareTx");
var signature_generator_1 = require("@waves/signature-generator");
var WavesKeeperAdapter = /** @class */ (function (_super) {
    __extends(WavesKeeperAdapter, _super);
    function WavesKeeperAdapter(_a) {
        var address = _a.address, publicKey = _a.publicKey;
        var _this = _super.call(this) || this;
        _this._onDestoryCb = [];
        _this._needDestroy = false;
        WavesKeeperAdapter._initExtension();
        _this._address = address;
        _this._pKey = publicKey;
        WavesKeeperAdapter.onUpdate(function (state) {
            if (!state.locked && (!state.account || state.account.address !== _this._address)) {
                _this._needDestroy = true;
                _this._onDestoryCb.forEach(function (cb) { return cb(); });
            }
        });
        return _this;
    }
    WavesKeeperAdapter.prototype.isAvailable = function (ignoreLocked) {
        if (ignoreLocked === void 0) { ignoreLocked = false; }
        return __awaiter(this, void 0, void 0, function () {
            var data, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, WavesKeeperAdapter.isAvailable()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, WavesKeeperAdapter._api.publicState()];
                    case 2:
                        data = _a.sent();
                        if (data.locked) {
                            return [2 /*return*/, ignoreLocked ? Promise.resolve() : Promise.reject({ code: 4, msg: 'Keeper is locked' })];
                        }
                    ...
                    case 3:
                        e_1 = _a.sent();
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/, Promise.reject({ code: 5, msg: 'Keeper has another active account' })];
                }
            });
        });
    };
    WavesKeeperAdapter.prototype.isLocked = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, WavesKeeperAdapter.isAvailable()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, WavesKeeperAdapter._api.publicState()];
                    case 2:
    ...
    WavesKeeperAdapter.prototype.onDestroy = function (cb) {
        if (this._needDestroy) {
            return cb();
        }
        this._onDestoryCb.push(cb);
    };
    WavesKeeperAdapter.prototype.getPublicKey = function () {
        return Promise.resolve(this._pKey);
    };
    WavesKeeperAdapter.prototype.getAddress = function () {
        return Promise.resolve(this._address);
    };
    WavesKeeperAdapter.prototype.getSeed = function () {
        return Promise.reject(Error('Method "getSeed" is not available!'));
    };
    WavesKeeperAdapter.prototype.signRequest = function (bytes, _, signData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.isAvailable(true)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, WavesKeeperAdapter._api.signRequest(signData)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    WavesKeeperAdapter.prototype.signTransaction = function (bytes, amountPrecision, signData) {
        return __awaiter(this, void 0, void 0, function () {
            var dataStr, _a, proofs, signature;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.isAvailable(true)];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, WavesKeeperAdapter._api.signTransaction(signData)];
                    case 2:
                        dataStr = _b.sent();
                        _a = JSON.parse(dataStr), proofs = _a.proofs, signature = _a.signature;
                        return [2 /*return*/, signature || proofs.pop()];
                }
            });
        });
    };
    WavesKeeperAdapter.prototype.signOrder = function (bytes, amountPrecision, signData) {
        return __awaiter(this, void 0, void 0, function () {
            var promise, dataStr, _a, proofs, signature;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.isAvailable(true)];
                    case 1:
                        ...
                        switch (signData.type) {
                            case prepareTx_1.SIGN_TYPE.CREATE_ORDER:
                                ...
                                break;
                            case prepareTx_1.SIGN_TYPE.CANCEL_ORDER:
                                promise = WavesKeeperAdapter._api.signCancelOrder(signData);
                                break;
                            default:
                                return [2 /*return*/, WavesKeeperAdapter._api.signRequest(signData)];
                        }
    ...
    WavesKeeperAdapter.prototype.signData = function (bytes) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.isAvailable(true)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, Promise.resolve('')]; //TODO
                }
            });
        });
    };
    WavesKeeperAdapter.prototype.getPrivateKey = function () {
        return Promise.reject('No private key');
    };
    WavesKeeperAdapter.isAvailable = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error, data, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._api.publicState()];
                    case 2:
                        data = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                    ...
                    case 4:
                        if (!error && data) {
                            ...
                            else if (!data.locked && (!data.account.address || !signature_generator_1.utils.crypto.isValidAddress(data.account.address))) {
    ...
    WavesKeeperAdapter.getUserList = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, WavesKeeperAdapter.isAvailable()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, WavesKeeperAdapter._api.publicState().then(function (_a) {
    ...
    WavesKeeperAdapter.initOptions = function (options) {
        Adapter_1.Adapter.initOptions(options);
        this.setApiExtension(options.extension);
    };
    WavesKeeperAdapter.setApiExtension = function (extension) {
        var extensionCb;
        if (typeof extension === 'function') {
            extensionCb = extension;
        }
        else if (extension) {
            extensionCb = function () { return extension; };
        }
        WavesKeeperAdapter._getApiCb = extensionCb;
    };
    WavesKeeperAdapter.onUpdate = function (cb) {
        WavesKeeperAdapter._onUpdateCb.push(cb);
    };
    WavesKeeperAdapter._initExtension = function () {
        if (WavesKeeperAdapter._api || !WavesKeeperAdapter._getApiCb) {
            return null;
        }
        this._api = WavesKeeperAdapter._getApiCb();
        if (this._api) {
            this._api.on('update', function (state) {
                for (var _i = 0, _a = WavesKeeperAdapter._onUpdateCb; _i < _a.length; _i++) {
                    var cb = _a[_i];
                    cb(state);
                }
            });
    ...
    WavesKeeperAdapter.type = "wavesKeeper" /* WavesKeeper */;
    WavesKeeperAdapter._onUpdateCb = [];
    return WavesKeeperAdapter;
}(Adapter_1.Adapter));
exports.WavesKeeperAdapter = WavesKeeperAdapter;

},{"../prepareTx":14,"./Adapter":2,"@waves/signature-generator":undefined}],7:[function(require,module,exports){
"use strict";
function __export(m) {
...
__export(require("./LedgerAdapter"));
__export(require("./SeedAdapter"));
__export(require("./TresorAdapter"));
__export(require("./WavesKeeperAdapter"));

},{"./Adapter":2,"./LedgerAdapter":3,"./SeedAdapter":4,"./TresorAdapter":5,"./WavesKeeperAdapter":6}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var SeedAdapter_1 = require("./adapters/SeedAdapter");
var LedgerAdapter_1 = require("./adapters/LedgerAdapter");
var adapters_1 = require("./adapters");
exports.adapterPriorityList = [
...
exports.adapterList = [
    SeedAdapter_1.SeedAdapter,
    LedgerAdapter_1.LedgerAdapter,
    adapters_1.WavesKeeperAdapter
];

},{"./adapters":7,"./adapters/LedgerAdapter":3,"./adapters/SeedAdapter":4}],9:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
__export(require("./prepareTx"));
__export(require("./config"));
__export(require("./Signable"));
var config_1 = require("./config");
function getAvailableList() {
    var _this = this;
    return Promise.all(config_1.adapterPriorityList
        .map(function (type) { return __awaiter(_this, void 0, void 0, function () {
        var adapter, available;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    adapter = getAdapterByType(type);
                    return [4 /*yield*/, adapter.isAvailable()];
                case 1:
                    available = _a.sent();
                    return [2 /*return*/, available ? adapter : null];
            }
        });
...
function getAdapterByType(type) {
    return utils_1.find({ type: type }, config_1.adapterList);
}
exports.getAdapterByType = getAdapterByType;

},{"./Signable":1,"./adapters":7,"./config":8,"./prepareTx":14,"./utils":17}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var _a;
var signature_generator_1 = require("@waves/signature-generator");
...
(function (SIGN_TYPE) {
    ...
    SIGN_TYPE[SIGN_TYPE["CUSTOM"] = 1005] = "CUSTOM";
...
exports.SIGN_TYPES = (_a = {},
    _a[SIGN_TYPE.AUTH] = {
        signatureGenerator: signature_generator_1.generate([
            new signature_generator_1.StringWithLength('prefix'),
            new signature_generator_1.StringWithLength('host'),
            new signature_generator_1.StringWithLength('data')
        ]),
        adapter: 'signRequest'
    },
    _a[SIGN_TYPE.COINOMAT_CONFIRMATION] = {
        signatureGenerator: signature_generator_1.generate([
            new signature_generator_1.StringWithLength('prefix'),
            new signature_generator_1.Long('timestamp')
        ]),
        adapter: 'signRequest'
    },
    _a[SIGN_TYPE.MATCHER_ORDERS] = {
        signatureGenerator: signature_generator_1.AUTH_ORDER_SIGNATURE,
        adapter: 'signRequest'
    },
    _a[SIGN_TYPE.CREATE_ORDER] = {
        signatureGenerator: signature_generator_1.CREATE_ORDER_SIGNATURE,
        adapter: 'signOrder'
    },
    _a[SIGN_TYPE.CANCEL_ORDER] = {
        signatureGenerator: signature_generator_1.CANCEL_ORDER_SIGNATURE,
        adapter: 'signRequest'
    },
    _a[SIGN_TYPE.TRANSFER] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.TRANSFER],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.ISSUE] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.ISSUE],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.REISSUE] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.REISSUE],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.BURN] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.BURN],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.EXCHANGE] = {
        signatureGenerator: signature_generator_1.generate([
            new signature_generator_1.StringWithLength('exchange-tx')
        ]),
        adapter: 'signRequest'
    },
    _a[SIGN_TYPE.LEASE] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.LEASE],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.CANCEL_LEASING] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.CANCEL_LEASING],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.CREATE_ALIAS] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.CREATE_ALIAS],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.MASS_TRANSFER] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.MASS_TRANSFER],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.DATA] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.DATA],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.SET_SCRIPT] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.SET_SCRIPT],
        adapter: 'signTransaction'
    },
    _a[SIGN_TYPE.SPONSORSHIP] = {
        signatureGenerator: signature_generator_1.TX_NUMBER_MAP[TRANSACTION_TYPE_NUMBER.SPONSORSHIP],
        adapter: 'signTransaction'
    },
    _a);

},{"@waves/signature-generator":undefined}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var fieldFactory = function (type) { return function (fromField, toField, processor, optional) {
    if (toField === void 0) { toField = fromField; }
...
exports.string = fieldFactory('string');
exports.asset = fieldFactory('assetId');
exports.assetName = fieldFactory('assetName');
exports.assetDescription = fieldFactory('assetDescription');
exports.precision = fieldFactory('precision');
exports.number = fieldFactory('number');
exports.address = fieldFactory('address');
exports.aliasName = fieldFactory('aliasName');
exports.aliasOrAddress = fieldFactory('aliasOrAddress');
exports.money = fieldFactory('money');
exports.numberLike = fieldFactory('numberLike');
exports.attachment = fieldFactory('attachment');
exports.httpsUrl = fieldFactory('httpsUrl');
exports.timestamp = fieldFactory('timestamp');
exports.orderType = fieldFactory('orderType');
exports.fromData = fieldFactory('fromData');
exports.boolean = fieldFactory('boolean');
exports.transfers = fieldFactory('transfers');
exports.data = fieldFactory('data');
exports.script = fieldFactory('script');
exports.required = fieldFactory('required');
...
},{"@waves/data-entities":undefined,"@waves/signature-generator":undefined}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var _1 = require("./");
function default_1(forSign) {
    var prepare = _1.getSchemaByType(forSign.type).sign;
    var dataForSign = prepare(forSign.data);
    var signatureGenerator = new _1.SIGN_TYPES[forSign.type].signatureGenerator(dataForSign);
...
__export(require("./getTxBytes"));

},{"./constants":10,"./getTxBytes":13,"./prepare":15,"./schemas":16}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var data_entities_1 = require("@waves/data-entities");
var signature_generator_1 = require("@waves/signature-generator");
var fieldValidator_1 = require("./fieldValidator");
var normalizeAssetId = function (id) { return id === signature_generator_1.WAVES_ID ? '' : id; };
var prepare;
(function (prepare) {
    var processors;
    (function (processors) {
        ...
        function toBigNumber(some) {
            switch (typeof some) {
                case 'string':
                case 'number':
                    return new data_entities_1.BigNumber(some);
                case 'object':
                    if (some instanceof data_entities_1.BigNumber) {
                        return some;
                    }
                    else {
        ...
        function recipient(data) {
            var code = String.fromCharCode(signature_generator_1.config.get('networkByte'));
            return data.length < 30 ? "alias:" + code + ":" + data : data;
        }
        processors.recipient = recipient;
        function attachment(data) {
            data = data || '';
            var value = Uint8Array.from(signature_generator_1.libs.converters.stringToByteArray(data));
            return signature_generator_1.libs.base58.encode(Uint8Array.from(value));
        }
        ...
        function quantity(data) {
            return new data_entities_1.BigNumber(data.quantity).times(new data_entities_1.BigNumber(10).pow(data.precision));
        }
...
},{"./fieldValidator":12,"@waves/data-entities":undefined,"@waves/signature-generator":undefined}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var _a;
...
},{"./constants":10,"./fieldTypes":11,"./prepare":15,"@waves/signature-generator":undefined}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
