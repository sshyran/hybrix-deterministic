...
var mode = 'bitshares';  // other modes: bitcoinjslib.bitcoin, ethereum, lisk
...
if(typeof deterministic!='object' || deterministic=={}) {
  ...
  var validated = deterministic.validate(tx[mode].source_address,function(result){logger('VALIDATED: '+result);});
